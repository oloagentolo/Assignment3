...
describe WorkOrdersController do
  ...
  describe "GET request for 'index'" do
    ...
    it 'should have the correct title' do
      get :index
      response.should have_selector('title', :content => 'Listing work orders')
    end
  end
  ...
  describe "GET request for 'edit'" do
    ...
    it 'should have the correct title' do
      get :edit, :id => @work_order
      response.should have_selector('title', :content => 'Edit work order')
    end
  end
  ...
  describe "GET request for 'show'" do
    ...
    it 'should have the correct title' do
      get :show, :id => @work_order
      response.should have_selector('title', :content => "Details for #{@work_order.status}")
    end
  end
